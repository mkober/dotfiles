...
vim.keymap.set('n', '<leader>vh', ':split<CR><C-W>j')
...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- https://github.com/nvim-lua/kickstart.nvim.gitany other, such as 'tokyonight-storm', 'tokyonight-moon', or 'tokyonight-day'.
